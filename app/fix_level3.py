...
with open('/app/src/main/java/com/example/creatoracademy/BrandCollaborationMentor.kt', 'r') as f:
    text = f.read()
...
"""
    ...
    new_text = text[:pos] + clean_code
    with open('/app/src/main/java/com/example/creatoracademy/BrandCollaborationMentor.kt', 'w') as f:
        f.write(new_text)
    print('Clean replaced Level 3 block successfully!')
else:
